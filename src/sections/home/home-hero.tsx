    ...
    >
      ...
      <m.div variants={varFade().in}>
        <Typography variant="body2" sx={{ textAlign: 'center' }}>
          A network of coaches, counsellors and psychologists are here to be your champions through
          it all! And it’s FREE for first 100 messages.
        </Typography>
      </m.div>
        ...
        >
          ...
          <Typography variant="caption" sx={{ color: 'text.secondary' }}>
            <Box component="strong" sx={{ mr: 0.5, color: 'text.primary' }}>
              Humans are awesome. AI + Humans are 10x awesome.
            </Box>
          </Typography>
        </Stack>
      </m.div>
        ...
        <Stack spacing={1.5} direction={{ xs: 'column-reverse', sm: 'row' }} sx={{ mb: 5 }}>
          <Stack alignItems="center" spacing={2}>
            <Button
              ...
              href={paths.users_auth.supabase.login}
              color="inherit"
              size="large"
              variant="contained"
